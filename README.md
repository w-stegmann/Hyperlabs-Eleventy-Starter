...
_Hinweis:_ Die Pfadangaben im Theme wie `/styles/style.css`, sind relativ zur obersten Ebene der Domain. Die Seite kann deshalb nicht in einem Unterordner abgelegt werden. Alternativ kann hier eine Subdomain sth.example.com angelegt werden.
